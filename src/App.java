...
public class App {
    ...
    public static int getKodeKhsDetailretake(String kodeKHS, String matKul, String studentID, ArrayList<Mahasiswa> mahasiswa, ArrayList<Matakuliah> matakuliah) {
        int idx = getIndexFromMahasiswa(mahasiswa, studentID);
    ...
    public static ArrayList<Matakuliah> initMataKuliah(ArrayList<Matakuliah> matKul) {
        ...
        // Kelas: 21SI2
        // Soal 1
        // Keterangan: Menambah sebuah tipe baik "SYS" maupun "FLA"
        Matakuliah matKul1 = new Matakuliah("SYS", "01_SD", "Struktur Data", 4);
        matKul.add(matKul1);
        Matakuliah matKul2 = new Matakuliah("FLA", "02_AD", "Agama Dunia", 3);
        matKul.add(matKul2);
        Matakuliah matKul3 = new Matakuliah("FLA", "03_BI", "Bahasa Indonesia", 2);
        matKul.add(matKul3); 
        Matakuliah matKul4 = new Matakuliah("FLA", "04_SS", "Soft Skill", 2);
        matKul.add(matKul4);
        Matakuliah matKul5 = new Matakuliah("SYS", "05_AA", "Algoritma", 4);
        matKul.add(matKul5);
        Matakuliah matKul6 = new Matakuliah("SYS","06_ST", "Statistika", 3);
        matKul.add(matKul6);
        Matakuliah matKul7 = new Matakuliah("FLA","07_WD", "Wawasan Dunia", 3);
        matKul.add(matKul7);
        Matakuliah matKul8 = new Matakuliah("SYS", "08_MD", "Matematika Diskrit", 3);
        matKul.add(matKul8);
        return matKul;
    } 
...
/*      public static ArrayList<Khs> initKhs(ArrayList<Khs> khs, ArrayList<Mahas{
    ...
    // Kelas: 21SI2
    // Soal 4
    // Keterangan: Membuat Validasi utk inputan tipe
    public static int validasiTipeMatkul(String tipeMatkul) {
        if (tipeMatkul.length() == 3) { //21001
            if (tipeMatkul.equals("SYS")) {
                return 1;
            } else if(tipeMatkul.equals("FLA")){
                return 1;
            }
            else{
                return 2;
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Kelas: 21SI2
        // Soal 1
        // Keterangan: Mendeklarasikan ArrayList tipematakuliah untuk mencetak Tipe Matakuliah 
        ArrayList<TipeMatakuliah> tipeMatakuliah = new ArrayList<TipeMatakuliah>();
        ...
        // Soal 2
        // Keterangan: 
        // - Mendeklarasikan tot untuk menampung nilai dari fungsi jumlahData() yang sudah dideklarasikan di Subclass TipeMatakuliah 
        // - Untuk fungsi 5 6 di Input/Cetak Matakuliah 
...
//        initKhsDetail(khsDetails, mataKuliah);
        ...
        // Kelas: 21SI2
        // Soal 1
        // Keterangan: Memasukkan semua data di matakuliah ke tipematakuliah
        for(Matakuliah matkul : mataKuliah){
            tipeMatakuliah.add(new TipeMatakuliah(matkul.getTipe(), matkul.getKodeMataKuliah(), matkul.getNamaMataKuliah(), matkul.getSks()));
        } 
        // Nama: Brian Albert
        // NIM: 03081210027
        // Kelas: 21SI2
        // Soal 2
        // Keterangan: Memasukkan jumlah data yang bertipe SYS dan FLA
        for (int i = 0; i <= tipeMatakuliah.size(); i++) {
            try{
                tot.add(tipeMatakuliah.get(i).jumlahData(tipeMatakuliah).get(i)); 
        ...
        // Kelas: 21SI2
        // Soal 3
        // Keterangan: Menggunakan fungsi tulisFile dan bacaFile 
        Util.tulisFile();
        System.out.println("Username & Password terkonfirmasi");
        Util.bacaFile();
        sleep(2000);
        ...
        while(yn.equalsIgnoreCase("y")){
            ...
            if (pilihan.equals("1")) {
                ...
                // Kelas: 21SI2
                // Soal 5
                // Keterangan: Membuat cetak semua sks untuk pilihan menu 
                System.out.println("4. Cetak Semua SKS Mata Kuliah (Ascending)  [No 5]");
                // Nama: Brian Albert
                // NIM: 03081210027
                // Kelas: 21SI2
                // Soal 1
                // Keterangan: Membuat cetak semua matakuliah FLA untuk pilihan menu 
                System.out.println("5. Cetak Semua Matakuliah FLA (No 1 & 2)");
                // Nama: Brian Albert
                // NIM: 03081210027
                // Kelas: 21SI2
                // Soal 1
                // Keterangan:
                // - Membuat cetak semua matakuliah SYS untuk pilihan menu 
                // - Menambah 4/5/6
                System.out.println("6. Cetak Semua Matakuliah SYS");
                ...
                if (opsi.equals("1")) {
                    ...
                    while (check == false) {
                        ...
                        // Kelas: 21SI2
                        // Soal 1
                        // Keterangan: Membuat kata-kata petunjuk untuk memasukkan tipe dan membuat sebuah inputan
                        System.out.print("Masukkan tipe mata kuliah : ");
                        String tipe = keyboard.next();
                        // Nama: Brian Albert
                        // NIM: 03081210027
                        // Kelas: 21SI2
                        // Soal 4
                        // Keterangan: Memvalidasi apabila tipe yang diinputkan tidak sesuai dengan yang diinginkan  
                        if(validasiTipeMatkul(tipe) == 1){         
                            while(true){
                                try {
                                    clearScreen();
                                    System.out.println("Input Mata Kuliah Baru");
                                    System.out.println("----------------------");
                                    System.out.println("Masukkan tipe mata kuliah : " + tipe);
                                    ...
                                    if (validasiKodeMatKul(kodeMatKul, mataKuliah) == 1) {
                                        ...
                                        while (true) {
                                            try {
                                                ...
                                                System.out.println("Input Mata Kuliah Baru");
                                                System.out.println("----------------------");
                                                System.out.print("Masukkan tipe mata kuliah : " + tipe);
                                                System.out.print("\nMasukkan kode mata kuliah : " + kodeMatKul);
                                                System.out.print("\nMasukkan nama mata kuliah : " + namaMatKul);
                                                System.out.print("\nMasukkan jumlah sks       : ");
                                                int sksMatKul = keyboard.nextInt();
                                                if (validasiSks(sksMatKul) == 1) {
                                                    mataKuliah.add(new Matakuliah(tipe ,kodeMatKul, namaMatKul, sksMatKul));
                                                    // Nama: Brian Albert
                                                    // NIM: 03081210027
                                                    // Kelas: 21SI2
                                                    // Soal 1
                                                    // Keterangan: ketika user menginput data baru, maka data tersebut akan ditambahkan di tipematakuliha dan matakuliah
                                                    tipeMatakuliah.add(new TipeMatakuliah(tipe, kodeMatKul, namaMatKul, sksMatKul));
                                                    check = true;
                                                    break;
                        ...
                        // Soal 4
                        // Keterangan: Memvalidasi apabila tipe yang diinputkan tidak sesuai dengan yang diinginkan  
                        } else if(validasiTipeMatkul(tipe) == 2){
                            System.out.println("Tipe harus berupa \"SYS\" atau \"FLA\" saja");
                            System.out.println("Note: Mohon untuk menginput dalam huruf besar semua");
                            sleep(2000);
                            continue;
                        } else {
                            System.out.println("Tipe harus dalam 3 digit");
                            sleep(2000);
                            continue;
                        }
                    ...
                    if (mataKuliah.size() > 0) {
                        ...
                        if (idx == -1) {
                            ...
                            // Kelas: 21SI2
                            // Soal 1
                            // Keterangan: Menambahkan output tipe
                            System.out.println("Tipe  : " + mataKuliah.get(idx).getTipe());
                    ...
                    System.out.println("\t\t\tData Mata Kuliah");
                    System.out.println("----------------------------------------------------------------");
                    System.out.printf("%-5s %-12s %-25s %-4s\n", "Tipe","Kode MatKul", "Nama MatKul", "Sks");
                    System.out.println("----------------------------------------------------------------");
                    for (Matakuliah matKul : mataKuliah) {
                ...
                // Soal 5
                // Keterangan: 
                // - Membuat menu tambahan untuk melihat sks yang sudah di urutkan 
                // - disarankan untuk menginput menu 3 terlebih dahulu untuk melihat sebelum sks di urutkan

                else if (opsi.equals("4")) {
                    clearScreen();
                    System.out.println("Note: Jika Data SKS yang ditampilkan belum berurut, user dapat mengulang menu 4 lagi");
                    System.out.println("----------------------------------------------------------------");
                    System.out.println("Data Semua SKS (Ascending)");
                    System.out.println("----------------------------------------------------------------");
                    System.out.printf("%-5s %-12s %-25s %-4s\n", "Tipe","Kode MatKul", "Nama MatKul", "Sks");
                    System.out.println("----------------------------------------------------------------");
                    // Nama: Brian Albert
                    ...
                    // Kelas: 21SI2
                    // Soal 5
                    // Keterangan: Proses untuk melakukan sorting 
                    for (Matakuliah matKul : mataKuliah) {
                        matKul.shellSort(mataKuliah);
                    }
                    // Nama: Brian Albert
                    // NIM: 03081210027
                    // Kelas: 21SI2
                    // Soal 5
                    // Keterangan: Proses untuk menampilakn hasil sorting 
                    for(Matakuliah matKul2 : mataKuliah){
                        matKul2.tampilkanDataMataKuliah();
                    }
                ...
                // Kelas: 21SI2
                // Soal 1
                // Keterangan: Menggunakan method tampilkanDataFLA()
                else if(opsi.equals("5")){
                    clearScreen();
                    System.out.println("----------------------------------------------------------------");
                    System.out.println("Data Semua Matakuliah Bertipe FLA");
                    System.out.println("----------------------------------------------------------------");
                    System.out.printf("%-5s %-12s %-25s %-4s\n", "Tipe","Kode MatKul", "Nama MatKul", "Sks");
                    System.out.println("----------------------------------------------------------------");
                    // Nama: Brian Albert
                    ...
                    // Kelas: 21SI2
                    // Soal 1
                    // Keterangan: jika tipenya adalah FLA, maka akan ditampilkan. 
                    int jmlh = 0;
                    int jmlh2 = 0;
                    for(TipeMatakuliah tipe : tipeMatakuliah){
                        if(tipe.getTipe().equals("FLA")){
                            tipe.tampilkanDataMataKuliahFLA();
                            jmlh++;
                        }
                    }
                    ...
                    // Kelas: 21SI2
                    // Soal 2
                    // Keterangan: memasukkan data yang direturn oleh jumlahData(ArrayList<TipeMatakuliah> x) ke Arraylist<Integer> tot
                    for (int i = 0; i <= tipeMatakuliah.size(); i++) {
                        try{ //menggunakan try catch untuk menjaga apabila terjadi error
                            tot.set(i,tipeMatakuliah.get(jmlh).jumlahData(tipeMatakuliah).get(i)); 
                        } catch (IndexOutOfBoundsException e) {
                            //TODO: handle exception
                            
                        }
                    }
                    // System.out.println("TOT FLA: ");
                    // for(Integer tot1 : tot){
                    //     try {
                    ...
                    // Kelas: 21SI2
                    // Soal 2
                    // Keterangan: Memasukkan return String yang berupa (Misalnya 1 = Satu, 2 = Dua) ke dalam Sebuah string kata
                    String kata = tipeMatakuliah.get(jmlh).jumlahData(tot.get(0));
                    System.out.println("----------------------------------------------------------------");
                    
                    System.out.println("Jumlah Data Bertipe FLA = " + tot.get(0) + " (" + kata + ") ");
                } 
                // Nama: Brian Albert
                // NIM: 03081210027
                // Kelas: 21SI2
                // Soal 1
                // Keterangan: Menggunakan method tamplikanDataSYS()
                else if(opsi.equals("6")){
                    clearScreen();
                    System.out.println("----------------------------------------------------------------");
                    System.out.println("Data Semua Matakuliah Bertipe SYS");
                    System.out.println("----------------------------------------------------------------");
                    System.out.printf("%-5s %-12s %-25s %-4s\n", "Tipe","Kode MatKul", "Nama MatKul", "Sks");
                    System.out.println("----------------------------------------------------------------");
                    int jmlh = 0;
                    ...
                    // Kelas: 21SI2
                    // Soal 1
                    // Keterangan: jika tipenya adalah SYS, maka akan ditampilkan. 
                    for(TipeMatakuliah tipe : tipeMatakuliah){
                        if(tipe.getTipe().equals("SYS")){
                            tipe.tampilkanDataMataKuliahSYS();
                            jmlh++;
                        }
                    }
                    ...
                    // Soal 2
                    // Keterangan: Memasukkan return String yang berupa (Misalnya 1 = Satu, 2 = Dua) ke dalam Sebuah string kata
                    String kata = tipeMatakuliah.get(jmlh).jumlahData(tot.get(1));
                    System.out.println("----------------------------------------------------------------");
                    System.out.println("Jumlah Data Bertipe SYS = " + tot.get(1) + " (" + kata + ") ");
                } 
                else {
                                            ...
                                            if (validasiKodeTermKrs(kodeTerm, studentID, mahasiswa) == 1) {
                                                ...
                                                while (yesNo.equalsIgnoreCase("y")) {
                                                    ...
                                                    if (Index == -1) {
                                                        ...
                                                        // Kelas: 21SI2
                                                        // Soal 1
                                                        // Keterangan: Menambah getTipe() di parameter 
                                                        mahasiswa.get(index).getKRS().get(Idx).getDaftarMataKuliah().add(new Matakuliah(mataKuliah.get(Index).getTipe(), mataKuliah.get(Index).getKodeMataKuliah(), mataKuliah.get(Index).getNamaMataKuliah(), mataKuliah.get(Index).getSks()));
                                                    }
                                                                                ...
                                                                                if (nilai >= 0 && nilai <= 100) {
                                                                                    ...
                                                                                    if (nilai < 60 && nilai >= 0) {
                                                                                                                ...
                                                                                                                while (true) {
                                                                                                                    try {
                                                                                                                        ...
                                                                                                                        if (validasiKodeKrs(kodeKrsBaru, studentID, mahasiswa) == 1) {
                                                                                                                            ...
                                                                                                                            // Soal 1
                                                                                                                            // Keterangan: menambah getTipe() di parameter
                                                                                                                            mhs.getKRS().get(indexKrs).getDaftarMataKuliah().add(new Matakuliah(mataKuliah.get(IDX).getTipe() , mataKuliah.get(IDX).getKodeMataKuliah(), mataKuliah.get(IDX).getNamaMataKuliah() + " (Retake)", mataKuliah.get(IDX).getSks()));
                                                                                                                            break;
                                                                                                                        }
                                                                                                                        else {
                                                                                                                            throw new Exception("\nKode KRS harus berupa 6 digit!");
                                                                                        ...
                                                                                        if (cekMatkulRetake(matKul, studentID, mahasiswa, mataKuliah) == 1) {
                                                                                            int idx = getKodeKhsRetake(matKul, studentID, mahasiswa, mataKuliah);
                                                                                            mhs.khs.get(idx).retake.add(new Retake(kodeDetailKHS, kodeKHS, mataKuliah.get(IDX), nilai, mahasiswa.get(index).getKHS().get(idx).getTerm()));
                                                                                            mhs.khs.get(Index).khsDetails.add(new KhsDetail(kodeDetailKHS, kodeKHS, mataKuliah.get(IDX), nilai));
                                                                                            int INDEX = getKodeKhsDetailretake(kodeKHS, matKul, studentID, mahasiswa, mataKuliah);
                                                                                            mhs.khs.get(Index).khsDetails.get(INDEX).setStringRetake("retake");
                                                                                        }
                                                                                        else mhs.khs.get(Index).khsDetails.add(new KhsDetail(kodeDetailKHS, kodeKHS, mataKuliah.get(IDX), nilai));
                                                                                    }
                                                                                    check2 = true;
                                                                                    check3 = true;
                                                                                    break;
            ...
            // Kelas: 21SI2
            // Soal 4
            // Keterangan: Memvalidasi apabila yn yang diinputkan tidak sesuai dengan yang diinginkan  
            boolean benar = true;
            do {
                try {
                    ...
                    yn = keyboard.next();
                    if(yn.length() != 1){
                        throw new Exception("Inputan hanya bisa 1 karakter saja");
                    } else if(yn.equalsIgnoreCase("n")){
                       break;
                    } else if (yn.equalsIgnoreCase("y")){
                        break;
                    } else {
                        System.out.println("Harap input dalam y atau n saja");
                        continue;
                    }
                } catch (Exception e) {
                    //TODO: handle exception
            ...
            clearScreen();
            System.out.println("Anda sudah terlog-out");
            System.out.println("\nTerima Kasih!\n");
            keyboard.close();
        }
}   
